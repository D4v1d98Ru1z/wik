...
ActiveRecord::Schema.define(version: 20170628010543) do
  ...
  add_index "collaborators", [nil], name: "index_collaborators_on_user_id"
  add_index "collaborators", [nil], name: "index_collaborators_on_wiki_id"
